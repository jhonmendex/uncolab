...
from inginious.frontend.plugins.un_colab.constants import _REACT_BUILD_FOLDER, _REACT_BASE_URL

_BASE_RENDERER_PATH = 'frontend/plugins/un_colab'


class ChatPage(INGIniousAuthPage):
    ...
    def GET_AUTH(self,course_id,task_id):
        ...
        return (
            self.template_helper.get_custom_renderer(_BASE_RENDERER_PATH).index(course_id,task_id)
        )
